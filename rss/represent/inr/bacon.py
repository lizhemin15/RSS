...
def BACONS(parameter):
    ...
    # 创建并返回 BACON 对象
    return BACON(parameter['dim_in'], parameter['dim_hidden'], parameter['dim_out'], 
                  hidden_layers=parameter['num_layers'], weight_scale=parameter['weight_scale'], 
                  bias=parameter['bias'], output_act=parameter['output_act'], 
